...
Today we'll use microsatellite data from the Weeks et al. (2017) paper using genetic analysis to look at the effects of population recovery after an introduction. You can download it [here](data/weeks_genotypes.csv).

Let's read in this file:

```{r}
data <- read.csv("data/weeks_genotypes.csv") # Read in a file
```
